...
class GetPropertyList2Request extends Request
{
    const ENDPOINT = 'GetPropertyList2';

    const PROPERTIES = [
        'ProjectDisplayFields'                 => ['string'],
        ...
        'IsGetAllDocumentsForOwnerLogin'       => 'boolean',
        'IsGettingAppointmentObject'           => 'boolean',
        'IsNotUsedPublicPriceWhenSortingPrice' => 'boolean',
        'IsYisual'                             => 'boolean',
